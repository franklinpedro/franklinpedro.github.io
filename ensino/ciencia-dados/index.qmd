...
**instruções para o envio de e-mails:** por favor, adicione `"[ciência de dados]"` no assunto da mensagem. o e-mail deve ser tratado como uma forma de comunicação profissional.
