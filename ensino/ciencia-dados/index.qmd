...
na coluna de referências, **r4ds** refere-se ao livro *r para ciência de dados* e **islr** ao livro *an introduction to statistical learning with applications in r*, todos disponíveis na bibliografia do curso.
